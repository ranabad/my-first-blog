...
class TestViews(TestCase):
    ...
    def test_CV_contents_with_Dlt_POST(self):
        ...
        posting=posting=self.c.post(self.url_workshopDlt,item.delete())
        self.assertEqual(Workshops.objects.count(),0)
        item=Experience.objects.create(id=1,text='q',date='a')
        posting=posting=self.c.post(self.url_expDlt,item.delete())
