...
class TestViews(TestCase):
    ...
    def test_CV_contents_with_Dlt_POST(self):
        Education.objects.create(id=1,text='q',date='a',grade='s')
        posting=posting=self.c.post(self.url_eduDlt,Education.objects.first().delete())
        self.assertEqual(Education.objects.count(),0)
        Skills.objects.create(id=1,text='q')
        posting=posting=self.c.post(self.url_skillDlt,Skills.objects.first().delete())
        self.assertEqual(Skills.objects.count(),0)
        Workshops.objects.create(id=1,text='q',date='a')
        posting=posting=self.c.post(self.url_workshopDlt,Workshops.objects.first().delete())
        self.assertEqual(Workshops.objects.count(),0)
        Experience.objects.create(id=1,text='q',date='a')
        posting=posting=self.c.post(self.url_expDlt,Experience.objects.first().delete())
        ...
        posting=posting=self.c.post(self.url_msgDlt,Contact.objects.first().delete())
