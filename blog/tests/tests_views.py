...
class TestViews(TestCase):
    ...
    def test_CV_contents_with_Dlt_POST(self):
        ...
        Skills.objects.create(id=1,text='q')
        posting=posting=self.c.post(self.url_skillDlt,id=1,text='q')
        self.assertEqual(Skills.objects.count(),0)
        Workshops.objects.create(id=1,text='q',date='a')
        posting=posting=self.c.post(self.url_workshopDlt,id=1,text='q',date='a')
        self.assertEqual(Workshops.objects.count(),0)
        Experience.objects.create(id=1,text='q',date='a')
        posting=posting=self.c.post(self.url_expDlt,id=1,text='q',date='a')
        ...
        posting=posting=self.c.post(self.url_msgDlt,id=1 ,from_email ='123@gmail.com',from_name='tester',subject ='views testing',message ='testing that views can delete id')
